<?php
        ...
        $mcFileManagerConfig['filesystem.path'] = '../../../../uploaded/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = '../../../../uploaded/'; // absolute or relative from this script path.
        ...
        $mcFileManagerConfig['SessionAuthenticator.logged_in_timeout_key'] = "loggedInTimeOut";
        $mcFileManagerConfig['SessionAuthenticator.logged_in_timeout'] = 25*60;
        $mcFileManagerConfig['SessionAuthenticator.groups_key'] = "mc_groups";
        $mcFileManagerConfig['SessionAuthenticator.user_key'] = "mc_user";
        ...
        $mcFileManagerConfig['SessionAuthenticator.config_prefix'] = "filemanager_";

        // ExternalAuthenticator config
        $mcFileManagerConfig['ExternalAuthenticator.external_auth_url'] = "auth_wlcms.php";
        $mcFileManagerConfig['ExternalAuthenticator.secret_key'] = "wlcmsSomeSecretKey";
