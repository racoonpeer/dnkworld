<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../uploaded/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../uploaded/'; // absolute or relative from this script path, required.
        ...
        $mcImageManagerConfig['SessionAuthenticator.logged_in_timeout_key'] = "loggedInTimeOut";
        $mcImageManagerConfig['SessionAuthenticator.logged_in_timeout'] = 25*60;
        $mcImageManagerConfig['SessionAuthenticator.groups_key'] = "mc_groups";
        $mcImageManagerConfig['SessionAuthenticator.user_key'] = "mc_user";
        ...
        $mcImageManagerConfig['SessionAuthenticator.config_prefix'] = "imagemanager_";

        // ExternalAuthenticator config
        $mcImageManagerConfig['ExternalAuthenticator.external_auth_url'] = "auth_wlcms.php";
        $mcImageManagerConfig['ExternalAuthenticator.secret_key'] = "wlcmsSomeSecretKey";
