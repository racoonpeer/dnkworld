...
class User_agent {
	...
	if (is_file(WLCMS_ABS_ROOT . 'include'.DS.'system'.DS.'user_agents.php')) {
	    include(WLCMS_ABS_ROOT . 'include'.DS.'system'.DS.'user_agents.php');
	} elseif (is_file(WLCMS_ABS_ROOT . 'include/system/user_agents.php')) {
	    include(WLCMS_ABS_ROOT . 'include/system/user_agents.php');
	} else {
	    return FALSE;
	}
