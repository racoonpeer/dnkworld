...
class Calendar {
	...
	if ($this->month_type == 'short') {
	    ...
	    $month_names = array('01' => '€нварь', '02' => 'февраль', '03' => 'март', '04' => 'апрель', '05' => 'май', '06' => 'июнь', '07' => 'июль', '08' => 'август', '09' => 'сент€брь', '10' => 'окт€брь', '11' => 'но€брь', '12' => 'декабрь');
	}
	...
	if ($this->day_type == 'long') {
	    $day_names = array('воскресенье', 'понедельник', 'вторник', 'среда', 'четверг', 'п€тница', 'суббота');
	} elseif ($this->day_type == 'short') {
	    $day_names = array('вос', 'пон', 'втр', 'срд', 'чет', 'птн', 'сбт');
	} else {
