                ...
                <table class="password-recovery-table form" align="center" cellspacing="0" cellpadding="0"><tbody>
                    <tr>
                        <td class="col2 frm-links" align="center">
                            <a href="<{include file='core/href_auto.tpl' arCategory=$arrModules.authorize arItem=array() params=''}>" title="<{$smarty.const.USER_LOGIN_TITLE}>" onclick="localRedirect(this);"><{$arrModules.authorize.title}></a>
                            &nbsp; | &nbsp;
                            <a href="<{include file='core/href.tpl' arItem=$arrModules.register}>" title="<{$smarty.const.USER_REGISTER_TITLE}>" onclick="parentRedirect(this);"><{$arrModules.register.title}></a>
                            &nbsp; | &nbsp;
                            <a href="<{include file='core/href.tpl' arItem=$arrModules.recovery}>" title="<{$smarty.const.TRY_AGAIN_ACTION}>" onclick="localRedirect(this);"><{$smarty.const.TRY_AGAIN_ACTION}></a>
                        </td>
                    </tr>
                </tbody></table>
            </center>
