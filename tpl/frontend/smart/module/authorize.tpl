<div class="m-title mt-oformlenia">
    <div class="mtc-l">Авторизация на сайте</div>
</div>
...
<{/if}>
                    <tr>
                        <td class="lbl"></td>
                        <td class="frm">
                            <input type="submit" name="submitAuthForm" value="Enter" onclick="return formCheck(this.form);" style="display:none;" />
                            <a id="submitForm" href="javascript:void(0);" onclick="formCheck(document.<{$arCategory.module}>Form);" class="obtn"><span>Вход</span></a>
                        </td>
                    </tr>
                    <tr>
                        <td class="frm" colspan="2" align="right">
                            <a href="<{include file='core/href.tpl' arItem=$arrModules.register}>" title="Регистрация на сайте">Регистрация на сайте</a>
                            &nbsp; | &nbsp;
                            <a href="<{include file='core/href.tpl' arItem=$arrModules.recovery}>" title="Восстановление пароля">Восстановление пароля</a>
                        </td>
                    </tr>
                </tbody>
            </table>
