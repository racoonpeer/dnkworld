                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="frm">
                            ...
                            <a href="<{include file='core/href_auto.tpl' arCategory=$arCategory arItem=$item params=''}>" class="obtn"><span>Отменить</span></a>
                        </td>
                    </tr>
                    <tr>
    ...
    <table class="fix-position"><tr><td>
        ...
        <table class="userdataform" align="center">
            <tbody>
                ...
                <tr>
                    <td class="lbl"></td>
                    <td class="frm"><a href="<{include file='core/href_auto.tpl' arCategory=$arCategory arItem=$item params='action=edit'}>" class="obtn"><span>Редактировать</span></a></td>
                </tr>
            </tbody>
        </table>
    </td></tr></table>
            ...
            <table class="item">
                <tr>
                    <td class="i" rowspan="2">
                        <a class="title" href="<{include file='core/href_auto.tpl' arCategory=$arCategory arItem=$items[i] params=''}>">
                            <img alt="" src="<{$items[i].small_image}>" />
                        </a>
                    </td>
                    <td class="t">
                        <p><a href="<{include file='core/href_auto.tpl' arCategory=$arCategory arItem=$items[i] params=''}>"><{$items[i].title}></a></p>
                    </td>
                </tr>
                <tr>
                    <td class="t">
                        <p><a class="detail" href="<{include file='core/href_auto.tpl' arCategory=$arCategory arItem=$items[i] params=''}>">Детальная информация</a></p>
                    </td>
                </tr>
            </table>
<{/section}>
...
<div class="m-body mb-oformlenia">
    ...
    <table class="fix-position"><tr><td>
        ...
        <p><a href="<{include file='core/href_auto.tpl' arCategory=$arrModules.authorize arItem=array() params=''}>" class="obtn" title="Авторизация"><span><{$arrModules.authorize.title}></span></a></p>
    </td></tr></table>
</div>
<{/if}>
