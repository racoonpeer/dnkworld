<script type="text/javascript">
    $(document).ready(function() {
        ...
        var scriptURL = '/interactive/ajax.php?zone=admin&action=ajaxBlogFilesUpload&<{$smarty.const.WLCMS_SESSION_NAME}>=<{$sessionID}>&PID=<{$arrPageData.pid}>&module=<{$arrPageData.pmodule}>&file_prefix=<{$arrPageData.userfileprefix}>';
        $('#userFile').uploadify({
            'queueID'        : 'fileQueue',
