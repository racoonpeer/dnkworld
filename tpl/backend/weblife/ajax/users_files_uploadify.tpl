                                ...
                                <div id="upload_box">
                                    <fieldset>
                                        ...
                                        <div id="upload_links_box">
                                            ...
                                            <a href="javascript:$('#userFile').uploadifyClearQueue();"><{$smarty.const.FILES_UPLOADIFY_CLEAR}></a>
                                        </div>
                                    </fieldset>
                                </div>
                            </td>
...
<{section name=i loop=$items}>
                     <tr>
                        ...
                        <td id="<{$items[i].idb}>"><a href="<{$arrPageData.files_url|cat:$items[i].filename}>" onclick="return parent.hs.expand (this, { })" class="highslide"><{$items[i].filename}></a></td>
